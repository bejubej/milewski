...
export const MAILS = [
  {
    id: 1,
    from: "Telekomunikacja Polska S.A TPSA",
    fromEmail: "sekretariat.lodz@tpsa.pl",
    to: "asp.szt. Adam Milewski",
    toEmail: "a.milewski@policja.gov.pl",
    subject: "RE: Wniosek o dane billingowe [nr rej.KWP/98/772/AD)",
    body: `Szanowny Panie Aspirancie,

Dział Obsługi Służb Ustawowo Uprawnionych TPSA Oddział w Łodzi potwierdza rejestrację Pana wniosku o nr KWP/98/772/AD.

Dane dla wskazanych numerów:

Abonent prywatny (048) 631-204-XXX

Abonent biznesowy (048) 631-342-XXX 

zostały skierowane do sekcji generowania logów z centrali cyfrowej w Piotrkowie Trybunalskim. Z uwagi na trwające prace konserwacyjne systemu bilingowego, arkusze połączeń zostaną wygenerowane w najbliższym oknie serwisowym.

Przewidywany termin wysyłki zestawienia pocztą specjalną na adres KWP w Łodzi to 21 dni roboczych. 

Informujemy jednocześnie, że bilingi będą zawierać czas trwania połączeń oraz treść wiadomości tekstowych (SMS) (z wyłączeniem numerów zastrzeżonych w bazie zastrzeżeń specjalnych MSWiA).

Z poważaniem,

Konrad Stasiak Dział Koordynacji i Współpracy z Organami Ścigania
    `,
    unread: true
  },
  {
  ...
  },
  {
    ...
    toEmail: "a.milewski@policja.gov.pl",
    subject: "Re: RAPORT",
    body: `Adam, kiedy wracasz z tych wojaży piotrkowskich, stary wypytuje o ciebie. nie wiem co tam znalazles ale nie rob nic na wlasna reke`,
    unread: false
  },
  {
    id: 4,
